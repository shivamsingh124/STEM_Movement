BlobWorld = new function() {
    ...
    var screenX = window.screenX*0.5;
    ...
    var skinIndex = 0;
    var skins = [
         { fillStyle: 'rgba(243, 188, 134,1.0)', strokeStyle: '#ffffff', lineWidth: 0, debug: false },
         { fillStyle: 'rgba(243, 188, 134,1.0)', strokeStyle: '', lineWidth: 0, debug: true },
       { fillStyle: 'rgba(0,0,0,0.1)', strokeStyle: 'rgba(255,255,255,0.5)', lineWidth: 6, debug: false },
  ...
  BlobWorld2 = new function() {
    ...
    this.init = function() {
      ...
      canvas = document.getElementById( 'world2' );
